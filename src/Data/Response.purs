...
import Capability.DataContract (class DataContract, encodeContractJson)
...
jsonResponse :: ∀ a b m. (Applicative m) => (EncodeJson a) => (DataContract a b) => b -> m DurableObjectResponse
